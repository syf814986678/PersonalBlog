<template>
  <div>
    <el-row style="margin-bottom: 5px">
      <el-col class="myblogtitle"
              style="font-size: 45px;font-weight: bold;font-family: Arial;word-break: break-all;text-align: center">
        {{ this.blog.blogTitle }}
      </el-col>
    </el-row>
    <el-row style="margin-bottom: 5px">
    ...
    <el-row style="margin-top: 2px;box-shadow: 0 0 50px 0 rgba(0,0,0,0.8);padding: 2px 0px;text-align: center">
      ...
      <el-col
        style=" font-size: medium;font-weight: bold;font-family: Arial;word-break: break-all;background-color: #ff7f50"
        :span="6">
        作者:{{ this.blog.user.userName }}
      </el-col>

      <el-col
        style=" font-size: medium;font-weight: bold;font-family: Arial;word-break: break-all;background-color: greenyellow"
        :span="6">
    ...
    <el-divider></el-divider>
    <el-row style="margin-top: 2px;box-shadow: 0 0 50px 0 rgba(0,0,0,0.8);padding: 2px 0px;text-align: center">
      <el-button round type="success" plain size="mini" style="font-size: 12px;font-weight: bold"
                 @click="downloadBlog(blog.blogId)"
      >保存至MARKDOWN文件
      </el-button>
    </el-row>
    <el-divider></el-divider>
...
export default {
  ...
  methods: {
    downloadBlog(blogId) {
      this.$http.post("/blog/common/download/0/" + blogId).then(response => {
        if (response != null) {
