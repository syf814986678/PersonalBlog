      ...
      <div>
        <el-row style="margin-top: 15px">
          ...
          <el-col :span="18" class="mycontent1">
            <h2 style="background-color: rgba(184,134,11,0.38)">
              <el-link v-html="result.blogTitle" :href="'/#/bloglist/blog/'+result.blogId" target="_blank"
                       style="font-size: 25px"></el-link>
            </h2>
            <div v-html="result.blogContent"
                 style="text-align:left;overflow: auto;word-break: break-all;margin: 0 10px;font-size: 20px;line-height: 30px;height: 100px"></div>
